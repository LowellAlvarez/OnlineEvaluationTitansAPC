	...
	<div class="row">
			...
			<div class="card card-info card-warning">
				...
				<div class="card-footer">
					<div class="d-flex justify-content-end w-100">
						<button class="btn btn-sm btn-warning btn-flat bg-gradient-warning mx-1" form="manage-question">Save</button>
		...
		<div class="col-md-8">
			<div class="card card-outline card-info">
				<div class="card-header">
					<b>Evaluation Questionnaire for Academic: <?php echo $year.' '.(ordinal_suffix($semester)) ?> Trimester </b>
					<div class="card-tools">
						<button class="btn btn-sm btn-flat btn-warning bg-gradient-warning mx-1" id="eval_restrict" type="button">Assign Faculty</button>
...
<script>
	...
	$('#eval_restrict').click(function(){
		uni_modal("Assign Faculty Subjects and Classes","<?php echo $_SESSION['login_view_folder'] ?>manage_restriction.php?id=<?php echo $id ?>","mid-large")
	})
