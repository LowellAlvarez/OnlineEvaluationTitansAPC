...
<div class="col-lg-12">
	<div class="card">
		<div class="card-body">
			<form action="" id="manage_director">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=director_list'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
...
<script>
	...
	$('#manage_director').submit(function(e){
		e.preventDefault()
		...
		$.ajax({
			url:'ajax.php?action=save_director',
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.replace('index.php?page=director_list')
					},750)
				}else if(resp == 2){
