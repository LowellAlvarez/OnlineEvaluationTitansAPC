...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="row">
			<div class="col-md-6">
				<dl>
					<dt><b class="border-bottom border-warning">Task</b></dt>
					<dd><?php echo ucwords($task) ?></dd>
				</dl>
				<dl>
					<dt><b class="border-bottom border-warning">Assign To</b></dt>
					<dd><?php echo ucwords($name) ?></dd>
				</dl>
				<dl>
					<dt><b class="border-bottom border-warning">Evaluator</b></dt>
					<dd><?php echo ucwords($ename) ?></dd>
				</dl>
				<dl>
					<dt><b class="border-bottom border-warning">Date Evaluated</b></dt>
					<dd><?php echo date("m d,Y",strtotime($date_created)) ?></dd>
				</dl>
				<dl>
				<dt><b class="border-bottom border-warning">Remarks</b></dt>
			...
			<div class="col-md-6">
				<b>Ratings:</b>
				<dl>
					<dt><b class="border-bottom border-warning">Efficiency</b></dt>
					<dd><?php echo $efficiency ?></dd>
				</dl>
				<dl>
					<dt><b class="border-bottom border-warning">Timeliness</b></dt>
					<dd><?php echo $timeliness ?></dd>
				</dl>
				<dl>
					<dt><b class="border-bottom border-warning">Quality</b></dt>
					<dd><?php echo $quality ?></dd>
				</dl>
				<dl>
					<dt><b class="border-bottom border-warning">Accuracy</b></dt>
					<dd><?php echo $accuracy ?></dd>
				</dl>
				<dl>
					<dt><b class="border-bottom border-warning">Performance Average</b></dt>
