							...
							<div class="card-body">
								<form action="" id="manage-criteria">
									...
									<div class="form-group">
										...
										<input type="text" name="criteria_notes" class="form-control form-control-sm">
									</div>
								</form>
							</div>
							<div class="card-footer">
								<div class="d-flex justify-content-end w-100">
									<button class="btn btn-sm btn-warning btn-flat bg-gradient-warning mx-1" form="manage-criteria">Save</button>
						...
						<div class="callout callout-info">
							...
							<div class="d-flex justify-content-between w-100">
								<label for=""><b>Criteria List</b></label>
									<button class="btn btn-sm btn-warning btn-flat bg-gradient-warning mx-1" form="order-criteria">Save Order</button>
							</div>
							<hr>
							...
							<ul class="list-group btn col-md-8" id="ui-sortable-list">
								...
								<li class="list-group-item text-left">
									...
									<p><small><?php echo ucwords($row['criteria_notes']) ?></small></p>
...
<script>
	$(document).ready(function(){
		...
		$('.edit_criteria').click(function(){
				...
				$('#manage-criteria').find("[name='criteria_notes']").val(criteria[id].criteria_notes)
